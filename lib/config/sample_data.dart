...
class SampleData {
  ...
  static List<Item> sampleItems = <Item>[
    Item.mock('1', null, "Topic 1", 0, 'FFF58C81'), // id 1
    Item.mock('2', '1', "Subtopic 1", 0), // id 2
    Item.mock('3', '1', "Subtopic 2", 0), // id 3
    Item.mock('4', '1', "Subtopic 3", 0), // id 4
    Item.mock('5', '1', "Subtopic 4", 0), // id 5
    Item.mock('6', null, "Topic 2", 0, 'FFE09F47'), // id 6
    Item.mock('7', '6', "Subtopic 1", 0), // id 7
    Item.mock('8', '6', "Subtopic 2", 0), // id 8
    Item.mock('9', '8', "Subtopic 1", 0), // id 9
    Item.mock('10', '8', "Subtopic 2", 0), // id 10
    Item.mock('11', '6', "Subtopic 3", 0), // id 11
    Item.mock('12', null, "Topic 3", 0, 'FFA9B852'), // id 12
    Item.mock('13', '12', "Subtopic 1", 0), // id 13
    Item.mock('14', '12', "Subtopic 2", 0), // id 14
    Item.mock('55', null, "Topic 4", 0, 'FF54C794'), // id 55
    Item.mock('56', null, "Topic 5", 0, 'FF00C4D7'), // id 56
    Item.mock('57', null, "Topic 6", 0, 'FF6EB2FD'), // id 57
    Item.mock('58', null, "Topic 7", 0, 'FFB69CF6'), // id 58
    Item.mock('59', null, "Topic 8", 0, 'FFE58CC5'), // id 59

    Item.mock('15', '1', "Note 01", 1),
    Item.mock('16', '3', "Note 02", 1),
    Item.mock('17', '2', "Note 03", 1),
    Item.mock('18', '2', "Note 04", 1),
    Item.mock('19', '3', "Note 05", 1),
    Item.mock('20', '4', "Note 06", 1),
    Item.mock('21', '4', "Note 07", 1),
    Item.mock('22', '5', "Note 08", 1),
    Item.mock('23', '6', "Note 00", 1),
    Item.mock('24', '6', "Note 10", 1),
    Item.mock('25', '7', "Note 11", 1),
    Item.mock('26', '7', "Note 12", 1),
    Item.mock('27', '8', "Note 13", 1),
    Item.mock('28', '9', "Note 14", 1),
    Item.mock('29', '9', "Note 15", 1),
    Item.mock('30', '10', "Note 16", 1),
    Item.mock('31', '10', "Note 17", 1),
    Item.mock('32', '11', "Note 18", 1),
    Item.mock('33', '12', "Note 19", 1),
    Item.mock('34', '12', "Note 20", 1),
    Item.mock('35', '14', "Note 21", 1),
    Item.mock('36', '13', "Note 22", 1),
    Item.mock('37', '13', "Note 23", 1),
    Item.mock('38', '13', "Note 24", 1),
    Item.mock('39', '14', "Note 25", 1),
    Item.mock('40', '14', "Note 26", 1),
  ];
}
...
old
  ...
  static List<Item> sampleItems = <Item>[
    Item.mock('1', null, "Projects", 0, 'FFF58C81'), // id 1
    ...
    Item.mock('6', null, "Software", 0, 'FFE09F47'), // id 6
    ...
    Item.mock('12', null, "Uni", 0, 'FFA9B852'), // id 12
    Item.mock('13', '12', "Praktikum", 0), // id 13
    Item.mock('14', '12', "Seminar", 0), // id 14
    Item.mock('55', null, "Business", 0, 'FF54C794'), // id 55
    Item.mock('56', null, "Jobs", 0, 'FF00C4D7'), // id 56
    Item.mock('57', null, "Interesting", 0, 'FF6EB2FD'), // id 57
    Item.mock('58', null, "Home", 0, 'FFB69CF6'), // id 58
    Item.mock('59', null, "Finance", 0, 'FFE58CC5'), // id 59
